...
final class PlanResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'calories_from' => $plan->calories_from !== null ? (int) $plan->calories_from : null,
            'calories_to' => $plan->calories_to !== null ? (int) $plan->calories_to : null,
            'calorie_label' => $plan->calorieLabel(),
