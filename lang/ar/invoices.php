...
return [
    ...
    'pdf' => [
        ...
        'terms' => 'هذه فاتورة ضريبية مبسطة صادرة وفق متطلبات الفوترة الإلكترونية لهيئة الزكاة والضريبة والجمارك. الأسعار شاملة ضريبة القيمة المضافة ما لم يُذكر غير ذلك. يُرجى الاحتفاظ بهذه الفاتورة.',
    ],
];
