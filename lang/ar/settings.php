...
return [
    ...
    'fields' => [
        ...
        'delivery' => [
            'fee_mode' => 'طريقة احتساب الرسوم',
            'free_above' => 'التوصيل مجاني إذا بلغت الفاتورة',
            'fixed_amount' => 'القيمة الثابتة',
            'included_km' => 'المسافة المشمولة (كم)',
            'included_price' => 'سعر المسافة المشمولة',
            'price_per_km' => 'سعر الكيلومتر بعد ذلك',
        ],
        'operations' => [
            ...
            'meal_change_lead_days' => 'أيام تغيير الوجبات المسموحة',
    ...
    'hints' => [
        'social' => [
            'whatsapp' => 'الرابط الكامل مثل https://wa.me/9665xxxxxxxx — اتركه فارغاً لإخفاء الأيقونة.',
            'instagram' => 'الرابط الكامل للصفحة. اتركه فارغاً لإخفاء الأيقونة.',
            'tiktok' => 'الرابط الكامل للحساب. اتركه فارغاً لإخفاء الأيقونة.',
            'snapchat' => 'الرابط الكامل للحساب. اتركه فارغاً لإخفاء الأيقونة.',
            'x' => 'الرابط الكامل للحساب. اتركه فارغاً لإخفاء الأيقونة.',
            'linkedin' => 'الرابط الكامل للصفحة. إن تُرك فارغاً تُستخدم صفحة NewMeKSA.',
        ],
        'authentication' => [
        ...
        'delivery' => [
            'fee_mode' => 'قيمة ثابتة = مبلغ واحد لكل طلب. حسب المسافة = سعر لأول كيلومترات، ثم سعر لكل كيلومتر بعدها.',
            'free_above' => 'إذا وصل مبلغ الفاتورة لهذا الرقم أو تجاوزه، التوصيل مجاني. 0 = لا يوجد توصيل مجاني بهذا الشرط. بالريال.',
            'fixed_amount' => 'نفس المبلغ على كل طلب، بغض النظر عن المسافة. بالريال.',
            'included_km' => 'اتركها 0 لتسعير كل كيلومتر من البداية. مثال: 15 يعني أول 15 كم بسعر ثابت.',
            'included_price' => 'مبلغ أول مسافة مشمولة. 0 = هذه الكيلومترات مجاناً.',
            'price_per_km' => 'يُحتسب على الكيلومترات الزائدة عن المسافة المشمولة. بالريال لكل كم.',
        ],
        'operations' => [
            ...
            'meal_change_lead_days' => 'عدد الأيام الجاية اللي يقدر العميل يغيّر وجباتها، بداية من بكرة. 2 = بكرة واليوم اللي بعده. اليوم نفسه غير مسموح.',
