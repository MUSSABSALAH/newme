...
class Container_539789db2e extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_539789db2e $container)
			{
	...
	public function createServiceContainer(): Container_539789db2e
	{
		return $this;
	}
