...
class Container_9b569ab700 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_9b569ab700 $container)
			{
	...
	public function createServiceContainer(): Container_9b569ab700
	{
		return $this;
	}
